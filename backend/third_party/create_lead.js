...
export const createLead = api({ expose: true, method: "POST", path: "/api/v1/leads" }, async (req) => {
    try {
        ...
        try {
            ...
            let existingCompany = await tx.queryRow `
        ...
        `;
            ...
            if (existingCompany) {
                ...
                // Create new company
                const newCompany = await tx.queryRow `
          ...
          `;
            ...
            let existingContact = await tx.queryRow `
        ...
        `;
          ...
          `;
                ...
                // Create new contact
                const newContact = await tx.queryRow `
            INSERT INTO people (
        ...
        `;
            ...
            // Create new deal
            const newDeal = await tx.queryRow `
          INSERT INTO deals (
