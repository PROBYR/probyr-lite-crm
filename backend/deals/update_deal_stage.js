...
export const updateDealStage = api({ expose: true, method: "PUT", path: "/deals/:id/stage" }, async (req) => {
    try {
        // Check if deal exists
        const existingDeal = await crmDB.queryRow `
...
//# sourceMappingURL=update_deal_stage.js.map