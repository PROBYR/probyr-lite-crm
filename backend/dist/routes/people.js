...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const { companyId, firstName, lastName, email, phone, jobTitle, status = 'New Lead', tagIds = [] } = req.body;
        if (!firstName) {
...
router.put('/:id', async (req, res) => {
    ...
    try {
        await client.query('BEGIN');
        const { id } = req.params;
        const { companyId, firstName, lastName, email, phone, jobTitle, status, tagIds } = req.body;
