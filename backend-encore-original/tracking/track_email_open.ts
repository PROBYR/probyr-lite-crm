...
export const trackEmailOpen = api<TrackEmailOpenParams, void>(
  { expose: true, method: "GET", path: "/track/open/:trackingId" },
  async (params) => {
    try {
      ...
      const existingOpen = await crmDB.queryRow<{ id: number }>`
