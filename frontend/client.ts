...
export const Local: BaseURL = process.env.VITE_BACKEND_URL || "http://localhost:4000"

/**
 * Environment returns a BaseURL for calling the cloud environment with the given name.
 */
export function Environment(name: string): BaseURL {
    return `https://${name}-probyr-lite-crm-nn42.encr.app`
}
...
/**
 * Client is an API client for the probyr-lite-crm-nn42 Encore application.
 */
export class Client {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "probyr-lite-crm-nn42-Generated-TS-Client (Encore/v1.50.0)";
        }
