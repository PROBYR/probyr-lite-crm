...
```bash
git remote add encore encore://probyr-lite-crm-nn42
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/probyr-lite-crm-nn42/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/probyr-lite-crm-nn42/settings/integrations/github)
